...
hidden if the `super_mario_bros_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `super_mario_bros_DEVELOPER_MODE` to the configure
...
Runs the executable target `super_mario_bros_exe`.
